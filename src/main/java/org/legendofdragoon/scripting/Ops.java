...
public enum Ops {
  ...
  OTHER_OTHER_STORAGE_1(0x3, (state, child) -> state.setParam(child, "state[state[this.storage[%d]].storage[%d]].storage[%d]".formatted(state.param0(), state.param1(), state.param2())).advance()),
  OTHER_OTHER_STORAGE_2(0x4, (state, child) -> state.setParam(child, "state[this.storage[%d]].storage[%d + this.storage[%d]]".formatted(state.param0(), state.param1(), state.param2())).advance()),
